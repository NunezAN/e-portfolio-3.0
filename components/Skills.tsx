...
export default function Skills({}: Props) {
  return (
    <div className="h-screen flex relative flex-col text-center md:text-left xl:glex-row max-w-[1200px] xl:px-10 min-h-screen justify-center  mx-auto items-center">
      ...
      <div className="grid grid-cols-3 sm:grid-cols-4 gap-5 md:gap-y-8 xl:gap-y-8 xl:mt-20 md:mt-20 mt-12 sm:mt-0">
        <Skill
