...
export default function Skills({}: Props) {
  return (
    <div className="h-screen flex relative flex-col text-center md:text-left xl:glex-row max-w-[1200px] xl:px-10 min-h-fit sm:min-h-screen justify-center  mx-auto items-center">
